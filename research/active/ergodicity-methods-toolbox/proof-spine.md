...
- successful coupling of fixed-size finite dual particle systems to classify invariant laws — **live**;
...
- super-Poincare reaction/diffusion decomposition for particle systems — **live**;
...
- generic block renormalization and bisection — **live**;
- deterministic bootstrap closure/legal emptying to positive stochastic gap — **live**;
...
- moving-particle/effective-resistance comparison — **live**;
- Lu--Yau canonical-sector recursion — **live**;
- two-scale canonical LSI / Kawasaki scaling — **live**;
