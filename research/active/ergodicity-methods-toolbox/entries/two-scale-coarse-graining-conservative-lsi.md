---
method_id: two-scale-coarse-graining-conservative-lsi
...
targets:
  ...
  - spectral-gap
  - convergence
model_scope: Canonical conservative spin systems where microscopic fibers and a coarse-grained marginal can be controlled separately
source_status: primary-checked
primary_source: Georg Menz and Felix Otto, Uniform logarithmic Sobolev inequalities for conservative spin systems with super-quadratic single-site potential, Annals of Probability 41 (2013), 2182-2224.
primary_pinpoint: Theorem 1.6 and Remark 1.7; Section 2 adapted two-scale approach, especially Proposition 2.1 and Theorem 2.6
primary_url: https://doi.org/10.1214/11-AOP715
application_source: Georg Menz and Felix Otto, Uniform logarithmic Sobolev inequalities for conservative spin systems with super-quadratic single-site potential, Annals of Probability 41 (2013), 2182-2224.
application_pinpoint: Theorem 1.6 for canonical ensemble LSI uniform in size and mean; Remark 1.7 for Kawasaki L^{-2} scaling
application_url: https://arxiv.org/abs/1307.2338
wiki_candidate: yes
---
