---
method_id: dynamical-disagreement-space-time-percolation
...
targets:
  ...
  - convergence
  - coupling-agreement
model_scope: Discrete-time spin PCA and continuous-time spin-flip IPS admitting a basic coupling whose disagreements propagate only along an associated oriented space-time percolation process.
source_status: primary-checked
primary_source: G. Gielis, C. Maes, and K. Vande Velde, "Randomly interacting particle systems: the uniqueness regime," Annales de l'Institut Henri Poincare, Physique theorique 70 (1999), 445-472.
primary_pinpoint: Section 4.1.1, Propositions 1-2; Section 4.1.2(i) and (iii), pp. 460-462; Theorems 1-2, pp. 453-454.
primary_url: https://www.numdam.org/item/AIHPA_1999__70_5_445_0/
application_source: G. Gielis, C. Maes, and K. Vande Velde, same paper.
application_pinpoint: Section 2 directed Stavskaya and Toom PCA examples; Theorems 1-2 and their proofs in Section 4.2.
application_url: https://www.numdam.org/item/AIHPA_1999__70_5_445_0/
wiki_candidate: yes
---
...
This differs from static disagreement percolation for Gibbs measures. Here the path lives in **space-time** and records propagation of an actual dynamical disagreement between coupled trajectories.
