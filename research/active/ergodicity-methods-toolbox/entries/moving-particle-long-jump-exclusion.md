---
method_id: moving-particle-long-jump-exclusion
title: Moving-particle and long-jump comparison for exclusion
category: functional-inequality
targets:
  - spectral-gap
  - convergence
model_scope: Symmetric exclusion and related conservative IPS on finite or exhausting weighted graphs
source_status: primary-checked
primary_source: Joe P. Chen, The moving particle lemma for the exclusion process on a weighted graph, Electronic Communications in Probability 22 (2017), paper no. 47, 1-13.
primary_pinpoint: Theorem 1.1 and equations (1.3)-(1.5); Section 1.1 comparison with the conventional path argument
primary_url: https://doi.org/10.1214/17-ECP82
application_source: Joe P. Chen, Local ergodicity in the exclusion process on an infinite weighted graph, Journal of Statistical Physics 170 (2018), 556-591.
application_pinpoint: Proposition 4.2 and Lemma 4.3; Sections 3-5 one-block/two-block and boundary-driven local ergodicity arguments
application_url: https://arxiv.org/abs/1705.10290
wiki_candidate: yes
---
