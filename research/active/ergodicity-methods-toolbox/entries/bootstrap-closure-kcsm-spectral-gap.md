---
method_id: bootstrap-closure-kcsm-spectral-gap
title: Bootstrap-percolation closure to KCSM spectral gap
category: kcsm-model-specific
targets:
  - spectral-gap
  - convergence
model_scope: Reversible finite-range kinetically constrained spin models with product equilibrium and an associated bootstrap closure
source_status: primary-checked
primary_source: Nicoletta Cancrini, Fabio Martinelli, Cyril Roberto, Cristina Toninelli, Kinetically constrained spin models, Probability Theory and Related Fields 140 (2008), 459-504.
primary_pinpoint: Definition 3.4, Theorem 3.3 and Corollary 3.5; Theorem 6.3 and Theorem 6.7 for FA applications
primary_url: https://doi.org/10.1007/s00440-007-0072-3
application_source: Nicoletta Cancrini, Fabio Martinelli, Cyril Roberto, Cristina Toninelli, Kinetically constrained spin models, Probability Theory and Related Fields 140 (2008), 459-504.
application_pinpoint: Theorem 6.3 for FA-1f and Theorem 6.7 for FA-jf/Modified Basic models
