---
method_id: relative-entropy-loss-gibbs-attractor
title: Relative-entropy loss and the Gibbs attractor principle
category: other
targets:
  - gibbs-attractor
  - convergence-under-unique-gibbs
model_scope: Translation-invariant finite-state lattice IPS, including irreversible finite-range local-update dynamics with a stationary Gibbs measure
source_status: primary-checked
primary_source: Benedikt Jahnel and Jonas Koppl, Dynamical Gibbs Variational Principles for Irreversible Interacting Particle Systems with Applications to Attractor Properties, Annals of Applied Probability 33 (2023), 4570--4607.
primary_pinpoint: Proposition 2.5; Theorem 2.6; Theorem 2.10; Proposition 3.18 and Section 3.5
primary_url: https://doi.org/10.1214/22-AAP1926
application_source: Benedikt Jahnel and Jonas Koppl, Dynamical Gibbs Variational Principles for Irreversible Interacting Particle Systems with Applications to Attractor Properties, Annals of Applied Probability 33 (2023), 4570--4607.
application_pinpoint: Theorem 2.10 and Section 3.5
application_url: https://arxiv.org/abs/2205.02738
wiki_candidate: yes
---
