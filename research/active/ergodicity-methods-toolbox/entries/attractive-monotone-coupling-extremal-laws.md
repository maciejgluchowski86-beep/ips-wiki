---
method_id: attractive-monotone-coupling-extremal-laws
...
targets:
  ...
  - convergence
  - coupling-agreement
model_scope: Binary attractive spin systems on partially ordered configuration spaces, especially one-dimensional nearest-neighbor systems
source_status: primary-checked
primary_source: Marcus Warfheimer, Attractive nearest-neighbor spin systems on the integers in a randomly evolving environment, arXiv:0712.2929v2 (2010)
primary_pinpoint: Definition 2.1 and equations (2.1)-(2.2), pp. 2-3; Theorem 2.2, p. 3; maximal-type coupling in Section 3, Tables 3.1-3.2, pp. 4-5
primary_url: https://arxiv.org/abs/0712.2929
application_source: Marcus Warfheimer, Attractive nearest-neighbor spin systems on the integers in a randomly evolving environment, arXiv:0712.2929v2 (2010)
application_pinpoint: Theorem 2.2 and Remark (ii), p. 3
application_url: https://arxiv.org/abs/0712.2929
wiki_candidate: yes
---
