...
primary_pinpoint: Theorem 3.1 (coupling-to-variance estimate), Theorem 3.2 and Corollary 3.3 (attractive/Ising application), and Proposition 4.7 (weak Poincare inequality and relaxation consequence)
...
application_pinpoint: Corollary 3.3 and Proposition 4.7
