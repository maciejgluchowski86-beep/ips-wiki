---
method_id: nested-super-good-droplet-renormalisation
title: Nested super-good-droplet renormalisation
category: kcsm-model-specific
targets:
  - spectral-gap
model_scope: Cooperative KCM in which a mobile droplet can be embedded recursively inside traversable regions on a hierarchy of increasing scales
source_status: primary-checked
primary_source: Ivailo Hartarsky, Fabio Martinelli, Cristina Toninelli, Sharp threshold for the FA-2f kinetically constrained model, Probability Theory and Related Fields 185 (2023), 993-1037.
primary_pinpoint: Definitions 4.2-4.3, Remark 4.4, Proposition 4.7, and Lemmas 4.9-4.10
primary_url: https://doi.org/10.1007/s00440-022-01169-2
...
application_pinpoint: Section 4, especially Proposition 4.7; Section 5 uses the mobile-droplet relaxation estimate in the sharp FA-2f upper bound
application_url: https://arxiv.org/abs/2012.02557
wiki_candidate: yes
---
