---
method_id: two-level-contact-block-restart-complete-convergence
title: Block-and-restart complete convergence in a two-level contact process
category: graphical-duality
targets:
  - convergence
  - extinction
model_scope: Contact-type systems in a dynamic contact-process environment, proved by supercritical block construction plus forward/dual restart
source_status: primary-checked
primary_source: Ruibo Ma, Complete convergence theorem for a two-level contact process, ALEA 19 (2022), 943–976
primary_pinpoint: Theorem 2; Theorem 3.5 and Proposition 3.6; Section 4, especially Section 4.1
primary_url: https://doi.org/10.30757/ALEA.v19-37
application_source: same as primary source
application_pinpoint: Theorems 1–2 and Sections 3–4
application_url: https://arxiv.org/abs/1904.08401
wiki_candidate: yes
---
