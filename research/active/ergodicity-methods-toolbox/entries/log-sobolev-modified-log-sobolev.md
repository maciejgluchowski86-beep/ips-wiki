---
method_id: log-sobolev-modified-log-sobolev
...
targets:
  ...
  - mixing
  - spectral-gap
model_scope: Reversible heat-bath and Glauber dynamics for weakly dependent spin systems
...
primary_pinpoint: Section 1.1, equations (1.8)-(1.11) and Proposition 1.1; Corollary 2.3 and Section 2.2 for high-temperature spin systems
...
application_pinpoint: Theorem 1.2 and Theorems 3.2 and 3.6
...
\]
They also record \(LS(C)\Rightarrow MLS(C/4)\Rightarrow P(C/2)\). Thus either inequality is stronger than a bare spectral-gap estimate, but mLSI is the one directly matched to relative-entropy dissipation.
...
A major proof device is entropy factorization. Caputo--Menz--Tetali define approximate tensorization
\[
