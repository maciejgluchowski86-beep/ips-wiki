---
method_id: aldous-interchange-exclusion-gap
title: Aldous interchange-process spectral-gap reduction
category: functional-inequality
targets:
  - spectral-gap
  - convergence
model_scope: Symmetric interchange and fixed-particle exclusion processes on finite connected weighted graphs
source_status: primary-checked
primary_source: Pietro Caputo, Thomas M. Liggett, Thomas Richthammer, Proof of Aldous' spectral gap conjecture, Journal of the American Mathematical Society 23 (2010), 831-851.
primary_pinpoint: Theorem 1.1 for interchange equals random-walk gap; Section 4.1.1 and equation (4.1) for symmetric exclusion
primary_url: https://doi.org/10.1090/S0894-0347-10-00659-4
application_source: Pietro Caputo, Thomas M. Liggett, Thomas Richthammer, Proof of Aldous' spectral gap conjecture, Journal of the American Mathematical Society 23 (2010), 831-851.
application_pinpoint: Section 4.1.1, equation (4.1): lambda_1^EP(G)=lambda_1^RW(G) for every particle number k=1,...,n-1
application_url: https://arxiv.org/abs/0906.1238
wiki_candidate: yes
---
...
This method is distinct from canonical-path comparison. Canonical paths bound one Dirichlet form by another with congestion loss. Aldous' theorem identifies an exact hidden spectral reduction: the many-particle gap itself is the graph random-walk gap.
