---
method_id: projective-consistency-splitting-gibbs-equilibrium
title: Projective consistency of finite-volume Gibbs marginals
category: finite-to-infinite
targets:
  - invariant-law-construction
model_scope: Nearest-neighbour hard-core loss networks on homogeneous Cayley trees with splitting Gibbs boundary messages
source_status: primary-checked
primary_source: James Martin, Utkir Rozikov and Yuri Suhov, A Three State Hard-Core Model on a Cayley Tree, Journal of Nonlinear Mathematical Physics 12 (2005), 432--448.
primary_pinpoint: Section 2, equations (2.1)--(2.3) and Proposition 1; Proposition 2 and Theorem 1 for Gibbs identification and the translation-invariant splitting solution
primary_url: https://doi.org/10.2991/jnmp.2005.12.3.7
application_source: James Martin, Utkir Rozikov and Yuri Suhov, A Three State Hard-Core Model on a Cayley Tree, Journal of Nonlinear Mathematical Physics 12 (2005), 432--448.
application_pinpoint: Abstract and Section 1 for the loss-network dynamics and reversibility of splitting Gibbs measures
application_url: https://doi.org/10.2991/jnmp.2005.12.3.7
wiki_candidate: yes
---
