---
method_id: finite-size-strong-mixing-criterion
...
targets:
  ...
  - convergence
  - mixing
model_scope: Finite-range discrete Gibbs spin systems and reversible single-spin Glauber dynamics on lattice boxes built from a sufficiently large basic cube
source_status: primary-checked
primary_source: Fabio Martinelli and Enzo Olivieri, Approach to equilibrium of Glauber dynamics in the one phase region. II. The general case, Communications in Mathematical Physics 161 (1994), 487-514.
primary_pinpoint: Section 1 finite-volume strong-mixing hypothesis and Theorems 1.2-1.3; Sections 2-3 block-decimation proof of the logarithmic-Sobolev and relaxation conclusions
primary_url: https://doi.org/10.1007/BF02101930
application_source: Fabio Martinelli and Enzo Olivieri, Approach to equilibrium of Glauber dynamics in the one phase region. II. The general case.
application_pinpoint: Theorem 1.3 and the abstract/main result: strong mixing in one finite cube Lambda_0 gives LSI, hypercontractivity, and uniform-norm exponential convergence in volumes that are multiples of Lambda_0
application_url: https://web.ma.utexas.edu/mp_arc-bin/mpa?yn=93-21
wiki_candidate: yes
---
