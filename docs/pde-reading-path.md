...
6. [regularity, well-posedness, and a priori estimates](entries/regularity-well-posedness-and-a-priori-estimates.md): regularity assumptions versus conclusions, existence, uniqueness, stability, and the distinction between an a priori estimate and an existence theorem.

These are deliberately prerequisites rather than compressed terminology lists.
