...
This entry is the drift-plus-small-set ergodicity criterion. [Exact regeneration at an atom](particle-collapse-regeneration.md) is a different proof interface when the renewal-cycle decomposition itself carries the argument.
