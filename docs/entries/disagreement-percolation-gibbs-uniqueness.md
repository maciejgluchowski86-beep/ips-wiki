...
This differs from [Dobrushin's sum-of-influences criterion](dobrushin-influence-contraction.md). It retains the geometry of influence propagation: many individually possible disagreements are harmless if they cannot form a long connected path.
