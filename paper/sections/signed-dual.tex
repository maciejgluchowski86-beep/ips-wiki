...
current monomial. We first define a general signed version of this process. The
death, split, and birth notation below is convenient for the patch construction.
Its rates and signs will be chosen from the generator~$\Lcal$ afterward.
...
monomial~$\chi_A$. Signs are multiplied in the usual way and act on real
...
\end{align*}
These are the usual additive set-valued transitions in a form convenient here.
