...
that the semigroup of a patch-positive system preserves this order. The proof
is algebraic: in finite volume the generator has nonnegative off-diagonal
entries in the centered-monomial basis.
