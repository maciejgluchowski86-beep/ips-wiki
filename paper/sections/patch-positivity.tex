...
Patch positivity concerns the full-patch factors in the representation. The end
factors depend additionally on the terminal configuration and will require a
one-density threshold below. Write
\begin{equation*}
...
Bulk positivity does not by itself determine the sign of an end contribution,
...
and nondecreasing, and it is nonnegative for~$p\geq p_i^\star$. The next
section uses this fact to expand the end factors around~$\mb p^\star$.
