...
\subsubsection{Conditional factorization}
...
\E_P^{\mathrm{con}}\Cb{f_P\bb{\Sigma_P}}.
\end{align*}
Every denominator is positive, as a patch with~$\pP_P\bb{\operatorname{Con}(P)}=0$ almost surely does not appear. Thus \eqref{eq:patch-factorization} is proven.
\end{proof}

\subsubsection{Patch contributions}
...
\subsubsection{Proof of Theorem~\ref{thm:patch-representation}}
...
\subsubsection{Product initial laws}
