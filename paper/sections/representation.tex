...
null set the ordinary records in~$G_T$ form a finite chronological list
\begin{equation*}
...
\end{equation*}
We retain only lists for which
$\delta_{i_k}(S_k)+\beta_{i_k}(S_k)>0$. The space of such lists is a countable
