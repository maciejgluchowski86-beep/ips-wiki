...
We prove part~\textup{(ii)} of Theorem~\ref{thm:patch-positivity-order}
...
\Bigg\}.
\end{align*}
Thus preservation of the centered-moment order reduces to the signs of these
coefficients and to expanding the products~$\chi_S\chi_B^*$ back in the
...
\end{equation*}
For the other coefficient family, first consider~$S=\vn$. Since
...
every finite~$S,B$. Thus, apart from the diagonal term
