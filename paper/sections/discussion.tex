...
outgoing patches it supplies a decaying factor for realizations with a
successful interaction after the cut time. When there is no such interaction,
it removes the
dependence of long end patches on the terminal configuration. The proof would extend to a hard
