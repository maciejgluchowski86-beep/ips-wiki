...
% ============================================================================
Now we prove that the result can be strenghtened to uniform exponential ergodicity, if the lattice is uniformly orientable.
Let~$h,r$ be witnesses to uniform orientability, as in Definition~\ref{def:orientability}. Fix~$f$
supported on a finite nonempty set~$A$. Choose the speed~$v$ in
Lemma~\ref{lem:finite-propagation} for error~$e^{-\varepsilon s/2}$. Set
\begin{gather*}
