...
process, successful interactions, and patch families. For any probability
measure~$\mu$, set
\begin{equation}
...
\ind\bb{\abs{\mathcal P}<\infty}.
\end{align*}
For~$\mu\in\mathcal M_*$, the pure-death comparison gives
\begin{equation}
...
\end{equation}
If a patch~$P$ ends at an outgoing successful interaction, i.e. is of type~$\mathsf{IO}$ or~$\mathsf{OO}$, then
\begin{equation}
...
\ref{lem:spatial-confinement}, in this order, imply
\begin{equation}
