...
with~$\chi_B^*$ centered at the original~$p_i^\star$. The coefficient
inequalities above, including the one for~$S=\vn$, give, by the argument
in Section~\ref{subsec:moment-monotonicity},
\begin{equation*}
