...
the system obtained by removing pure deaths, which will be used repeatedly; the
technical continuation and confinement identities used below are proved in
Appendix~\ref{app:technical-background}.

\paragraph{Late successful interactions.}
The proof of Corollary~\ref{cor:pure-death-comparison} already established the
...
\end{equation*}
The inequality is trivial when~$\abs{\mathcal P}=\infty$, since then~$W=0$.
