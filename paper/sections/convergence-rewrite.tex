...
% ============================================================================
\paragraph{Blurb A. The remaining task.}
Recall the two conclusions of Corollary~\ref{cor:oriented-ergodicity} and
the invariant measure~$\pi$ from Theorem~\ref{thm:common-invariant-limit}.
That theorem already gives convergence uniformly over~$\mathcal M_*$.
Explain that the remaining task is to bring~$\delta_\eta P_t$ close to
this class on finite sets. Introduce the idea in this order: prescribed
boundary conditions preserve patch positivity and the original centered-moment
class; uniform deaths allow extraction of a positive part in that class;
repeated extraction leaves a vanishing remainder. Blurb~E must justify why
this local approximation suffices for ergodicity, and Blurb~F must explain
what uniform orientability adds.
