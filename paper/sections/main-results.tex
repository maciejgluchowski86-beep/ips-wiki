...
system has~$\delta$-uniform deaths. For~$K\geq0$, let
\begin{equation*}
\mathcal M_{-,K}
=
\cb{
...
\end{equation*}
If~$\mb p^\star\leq\frac12\mb 1$, then every initial configuration is covered
with a common constant,~$\pi$ is the unique invariant measure, and
...
\subsection{Applications and organization}
