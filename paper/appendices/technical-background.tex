...
The next lemma contains the only algebra needed for the no-late estimate. A
direct telescoping argument applied before averaging is not available in
general: an end contribution may be negative at~$z=0$, and~$\mathcal M_*$
controls signs only after the centered expansion.
