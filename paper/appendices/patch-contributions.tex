...
later use, let~$P$ be an end patch based at~$i$, and let~$u\geq e(P)$. Write
$P^{\uparrow u}$ for its continuation through time~$u$ with no intervening
successful interaction, rooted at the original end patch~$P$. Its contribution,
including the conditional probability of this continuation, is
\begin{equation}
\label{eq:end-patch-continuation}
C\bb{z,P^{\uparrow u}}
=
C\bb{\psi_i\bb{u-e(P),z},P}.
\end{equation}
Since~$C(z,P)$ is affine,
\begin{equation}
\label{eq:end-patch-slope-relaxation}
\partial_z C\bb{z,P^{\uparrow u}}
=
e^{-r_i\bb{u-e(P)}}\partial_z C(z,P).
\end{equation}
