...
\tikzset{
  ...
  patch case label/.style={font=\scriptsize,text=outline,align=center,inner sep=0pt},
...
\draw[patch decomposition arrow] (1.80,1.42)--(4.43,1.42);
\begin{scope}[shift={(6.15,0)},scale=0.88]\FullPrism\IncomingInitial\IncomingTerminal\node[patch case label] at (0,-1.20) {no death};\end{scope}
\begin{scope}[shift={(10.5,0)},scale=0.88]\DeathPrism\IncomingInitial\IncomingTerminal\node[patch case label] at (0,-1.20) {death};\end{scope}
\end{tikzpicture}}
...
\draw[patch decomposition arrow] (1.80,1.42)--(4.43,1.42);
\begin{scope}[shift={(6.15,0)},scale=0.88]\EmptyPrism\OutgoingAt{0}\IncomingTerminal\node[patch case label] at (0,-1.20) {split};\end{scope}
\begin{scope}[shift={(10.5,0)},scale=0.88]\FullPrism\OutgoingAt{0}\IncomingTerminal\node[patch case label] at (0,-1.20) {birth, no death};\end{scope}
\begin{scope}[shift={(14.85,0)},scale=0.88]\DeathPrism\OutgoingAt{0}\IncomingTerminal\node[patch case label] at (0,-1.20) {birth, then death};\end{scope}
\end{tikzpicture}}
