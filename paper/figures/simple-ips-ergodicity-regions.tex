...
\begin{tikzpicture}[scale=4, line cap=round, line join=round]
  ...
  \begin{scope}[shift={(0.12,-0.42)},every node/.style={anchor=west,font=\small}]
    ...
    \fill[darkgray!25] (0,-0.11) rectangle (0.065,-0.055);
    \node at (0.09,-0.0825) {Long-lived-state criterion~\cite{GluchowskiMenz2026}};
    \fill[red!25] (1.40,0) rectangle (1.465,0.055);
    \node at (1.49,0.0275) {Corollary~\ref{cor:oriented-ergodicity}};
