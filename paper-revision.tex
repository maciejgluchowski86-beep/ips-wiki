...
\ind\bb{\abs{\mathcal P}<\infty}.
\end{align*}
By Section~\ref{subsec:proof-pure-death-comparison}, the two systems have the
same successful-interaction skeleton and patch families, and for
...
interaction. If that patch starts at another successful interaction, move to
...
\end{equation*}
The boundary times decrease strictly when this construction is followed
...
initial interaction at time~$0$ after finitely many steps. In particular,
\begin{equation}
...
On~$L_{T,t}^c$, let~$u\in(T,t]$ be the first successful interaction
