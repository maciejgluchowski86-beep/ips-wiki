...
The continuation identity reduces the dependence on the initial configuration
...
\eqref{eq:local-no-late-factorization} and expanding each affine factor around
~$p_i^\star$ gives
\begin{align}
&\CP{L_{T,t}}{\mathcal G_T}
\mu\bb{
