...
This representation explains the patch positivity condition introduced above. The coefficient
...
that reach the observation time retain factors depending on the initial measure on~$\eta$, and the threshold profile~$\mb p^\star$ is chosen so that these factors
are non-negative for product measures with density profile above~$\mb p^*$. The resulting
