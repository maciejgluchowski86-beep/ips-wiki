...
\end{equation*}
\textcolor{red}{Thus~$\alpha_i$ is the total rate of outgoing marks at~$i$, and}
...
probability; every realized patch has a positive normalizer.}
...
\textcolor{red}{Suppose first that the initial boundary is incoming, so
