...
from homogeneous product measures can be used as the endpoints of a centered
monomial comparison. This gives exponential convergence to equilibrium for a
class of dependent and non-translation-invariant initial laws; see
Corollary~\ref{cor:babp-centered-convergence}. For simple one-sided spin
systems, patch positivity together with orientability gives a new sufficient
condition for uniform ergodicity under positive rates, extending the regions
covered by earlier criteria~\cite{GluchowskiMenz2025,GluchowskiMenz2026}; see
Corollary~\ref{cor:simple-positive-rates} and
Figure~\ref{fig:simple-ips-ergodicity-regions}.\section{Setup and examples}
\label{sec:setup}
