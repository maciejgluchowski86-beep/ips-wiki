...
The out-of-equilibrium behaviour of FA-1f and East has been studied in a
number of settings; see
\cite{CancriniEtAl2010,BlondelEtAl2013,MountfordValle2019,Mareche2019,
HartarskyToninelli2024}. These results provide model-specific convergence
theorems for the hard dynamics, complementary to the comparison and noisy
ergodicity results proved here.
...
here remains open. We refer to it as the positive rates conjecture for simple
spin systems: every system satisfying~\eqref{eq:simple-positive-rates} should
be ergodic. Earlier sufficient conditions cover parts of the parameter space
