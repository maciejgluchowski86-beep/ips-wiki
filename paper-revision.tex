...
If
\begin{equation*}
p_i^-:=\max\cb{2p_i^\star-1,0},
\end{equation*}
then a Bernoulli product measure~$\mu_{\mb p}$ belongs to
$\mathcal M_{-,1}$ exactly when~$\mb p\geq\mb p^-$. In particular, if
$\mb p^\star\leq\mbs{\tfrac12}$, then every Bernoulli product measure
belongs to~$\mathcal M_{-,1}$.
