...
Corollary~\ref{cor:babp-centered-convergence}. For one-dimensional, one-sided nearest neighbor spin systems (called Simple IPS) studied in~\cite{GluchowskiMenz2025,GluchowskiMenz2026}, patch positivity together with orientability gives a new sufficient
...
Corollary~\ref{cor:simple-positive-rates}.\section{Setup and examples}
\label{sec:setup}
