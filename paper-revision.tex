...
Section~\ref{subsec:dual-graphical-construction}, we give the particular form of the
graphical construction of the process, from which in
Section~\ref{sec:patches} the patches are constructed.
