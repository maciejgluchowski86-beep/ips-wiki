...
ingredient here is the choice of the smaller~$\sigma$-algebra~$\mathcal G_t$:
by retaining the interactions between sites but averaging over the local
information between them, the signed dual weight becomes the product of
one-site patch contributions in~\eqref{eq:intro-patch-factorization}. It is
