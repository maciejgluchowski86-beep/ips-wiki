...
To include the starting set in the same record, we adjoin the formal record
~$(\infty,0,A)$, where~$\infty\notin\Lambda$ is a formal source. For
...
at every site in~$S$. Consequently, on each site line the retained interaction
times divide time into consecutive intervals between one incoming or outgoing
