...
contributions can therefore cancel inside~$C(P)$ or~$C(z,P)$.

The coefficient condition called patch positivity in
Section~\ref{sec:main-results} is shown in Section~\ref{sec:proofs} to make
every full-patch contribution~$C(P)$ nonnegative. End contributions retain the
terminal argument~$z$; their sign control gives the threshold profile.
...
\subsection{Patch contributions under patch positivity}
\label{subsec:proof-patch-contributions}

\subsection{Centered monomial monotonicity: proof of Theorem~\ref{thm:centered-monomial-monotonicity}}
\label{subsec:proof-centered-monomial-monotonicity}

\subsection{Extremal limits and comparison: proof of Corollary~\ref{cor:extremal-limits-comparison}}
\label{subsec:proof-extremal-limits-comparison}

\subsection{Pure-death comparison: proof of Corollary~\ref{cor:pure-death-comparison-revision}}
\label{subsec:proof-pure-death-comparison}

\subsection{Common invariant limit: proof of Theorem~\ref{thm:common-invariant-limit}}
\label{subsec:proof-common-invariant-limit}

\subsection{Uniform exponential ergodicity: proof of Corollary~\ref{cor:uniform-exponential-ergodicity}}
\label{subsec:proof-uniform-exponential-ergodicity}

\subsection{Uniform ergodicity under orientability: proof of Corollary~\ref{cor:oriented-ergodicity}}
\label{subsec:proof-oriented-ergodicity}
