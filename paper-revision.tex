...
the infinite-volume statement follows by the finite-propagation approximation
from the appendix.

If~$i\notin A$, an update at~$i$ leaves~$\chi_A^\star$ unchanged. If~$i\in A$, then
\begin{equation*}
...
It remains to expand the products of ordinary and centered monomials in
\eqref{eq:centered-monomial-generator-expansion}. For finite
~$S,B\subseteq\Lambda$,
\begin{equation}
