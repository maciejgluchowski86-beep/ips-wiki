...
\textcolor{red}{This section constructs the signed set-valued dual process used later in the
patch representation. Set-valued duals for spin systems are standard, see
~\cite{Harris1978,Griffeath1979,Gray1986}. The features needed here are the signed
...
is a Feynman--Kac potential. We now define the signed process and
