...
covered by these criteria. The additional red region is empty in the
~$p_{1\mid00}=1/4$ section. The figure format is adapted from Figure~3 of
~\cite{GluchowskiMenz2026}.}
