...
positivity comes from the representation developed in Sections~5 and~6, where
the condition is shown to have a probabilistic interpretation in terms of
nonnegative patch contributions.
