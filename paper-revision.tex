...
patch representation with its limit after the successful-interaction skeleton
has stopped. Fixing a cut time~$T<t$, there are three sources of error. First,
...
It remains enough to prove the quantitative convergence estimate uniformly over
