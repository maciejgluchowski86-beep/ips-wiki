...
\subsection{\textcolor{red}{All-zero-neighbourhood relaxation}}
...
\textcolor{red}{Thus, when~$\lambda_i(\mb 0)>0$, the value~$z$ is forgotten
exponentially fast and replaced in the limit by~$\rho_i(\mb 0)$. The second
identity describes the same evolution over two consecutive time intervals.
The geometric extension of end patches and the corresponding continuation
identity are introduced later, where they are used in the proof of relaxation
