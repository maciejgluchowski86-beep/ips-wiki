...
patch-positive and its threshold profile is the same as that of~$\Lcal$, because
the formula~\eqref{eq:threshold-profile} only involves the nonempty
coefficients in~\eqref{eq:pure-death-mobius-identities}. For an end patch~$P$ based at
site~$i$, set
\begin{equation*}
