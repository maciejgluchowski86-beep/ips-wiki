...
In this section we construct a dual process to the spin system. Set-valued duals for spin systems are standard, see~\cite{Harris1978,Griffeath1979,Gray1986}. We also introduce a particular graphical realization of the process that is used in Section~\ref{sec:patches} for the patch representation.
...
\end{equation*}
The dual representation we show is
\begin{equation}
...
observation time,~$\sigma_s\in\cb{+,-}$ is the sign process, and~$V$
is a Feynman--Kac potential.
