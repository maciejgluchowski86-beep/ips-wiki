...
identify its threshold profile, and then record the comparison or convergence
consequences that follow. FA-1f and the East model are the main KCSM examples,
BABP illustrates the centered monomial order outside the KCSM class, the
contact process serves as a benchmark where the usual configuration order is
already available, and simple spin systems give an application to the
positive-rates problem.
