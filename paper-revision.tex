...
site is active, a death makes it inactive, whereas a nonempty-target
interaction would be a successful interaction. Once the site is inactive it
remains inactive in this one-site evolution. Let~$L_{T,t}^P$ be the event that
no nonempty-target interaction occurs while the site is active during
~$(T,t]$. Distinct end patches are based at distinct sites, so conditional on
